...
def expense_inputs() -> rx.Component:
    """Only renders the expense input fields."""
    expense_items = [
        ("housing", "home"),
    ...
    return rx.el.div(
        rx.foreach(
            ...
            lambda item: input_field(
                ...
                icon=item[1],
                # ✅ Use `value` instead of `default_value`
                value=CalculatorState.expenses[item[0]].to_string(),
    ...
    return card(
        ...
        rx.el.div(
            ...
            rx.cond(
                ...
                rx.el.p(
                    f"Using averages for {CalculatorState.city}",
